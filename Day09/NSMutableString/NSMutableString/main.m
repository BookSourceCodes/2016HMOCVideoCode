...
int main(int argc, const char * argv[]) {
    ...
    [str1 appendFormat:@"sbv"];
    
    [p1 eat:str1];
    
    NSMutableString *str2 = @"jack";
    [str appendFormat:@"cctv"];
    
    // 子类指针
    
    NSMutableString *str3 = [NSMutableString string]; // @""
    
    [str3 appendFormat:@"jack"]; // str @"jack"
    [str3 appendFormat:@"rose"]; // @"jackrose"
    [str3 appendFormat:@"lili"];
    
    int age = 10;
    [str3 appendFormat:@"我今年%d岁了.", age];
    ...
    NSString *str4 = @""; // @""
    for (int i = 0; i < 50000; i++) {
        str4 = [NSString stringWithFormat:@"%@%d", str, i];
    }
    NSLog(@"-----------");
