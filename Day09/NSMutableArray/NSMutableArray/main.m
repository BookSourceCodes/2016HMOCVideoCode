...
int main(int argc, const char * argv[]) {
    ...
    NSArray *arr2 = @[@"rose", @"lili", @"lucy", @"poly"];
    [arr1 addObject:arr2]; // 将传入的数据作为可变数组的一个元素.
    ...
    NSMutableSet *arr5 = [NSMutableArray arrayWithObjects:@"jack", @"rose", @"lili", nil];
    
    NSMutableArray *arr6 = [NSMutableArray arrayWithObjects:@"jack", @"rose", @"lili", nil];
    NSMutableArray *arr7 = @[@"jack", @"rose", @"lili"];
