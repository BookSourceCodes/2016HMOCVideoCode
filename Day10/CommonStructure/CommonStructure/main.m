...
int main(int argc, const char * argv[]) {
    ...
    CZButton *btn2 = [[CZButton alloc] init];
    btn2.point = CGPointMake(100, 100);
    btn2.size = CGSizeMake(100, 30);
    btn2.text = @"点我呀";
    
    [view1.subViews addObject:btn2];
    
    CZButton *btn3 = [[CZButton alloc] init];
    btn3.point = CGPointMake(200, 200);
    btn3.size = CGSizeMake(100, 30);
    btn3.text = @"注册";
    
    [view1.subViews addObject:btn3];
    
    CGSize size0 = CGSizeMake(100, 30);
    CGSize size1 = NSMakeSize(100, 30);
    
    CGPoint p2 = CGPointMake(20, 30);
    NSLog(@"p2.x = %lf p2.y = %lf", p2.x, p2.y);
    
    NSPoint p3 = NSMakePoint(20, 30);
