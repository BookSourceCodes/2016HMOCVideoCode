...
int main(int argc, const char * argv[]) {
    ...
    BOOL res1 = [manager moveItemAtPath:@"/Users/Apple/Desktop/haha.txt" toPath:@"/Users/Apple/Desktop/heihei.txt" error:nil];
    LogBOOL(res1);
    
    BOOL res2 = [manager copyItemAtPath:@"/Users/Apple/Desktop/abc.plist" toPath:@"/Users/Apple/abc.plist" error:nil];
    LogBOOL(res2);
    
    BOOL res3 = [manager createDirectoryAtPath:@"/Users/Apple/Desktop/AA/DD/CC/BB/ZZ" withIntermediateDirectories:YES attributes:nil error:nil];
    if (res3 == YES) {
        NSLog(@"成功");
    } else {
        NSLog(@"失败");
    ...
    BOOL res4 = [manager createFileAtPath:@"/Users/Apple/Desktop/haha.txt" contents:nil attributes:nil];
    if (res4 == YES) {
        NSLog(@"成功");
    } else {
        NSLog(@"失败");
    ...
    NSArray *arr1 = [manager subpathsAtPath:@"/Users/Apple/Desktop/1010IOS基础班"];
    ...
    BOOL res5 = [manager isDeletableFileAtPath:@"/System"];
    LogBOOL(res5);
    
    BOOL res6 = [manager isReadableFileAtPath:@"/Users/test/Desktop"];
    LogBOOL(res6);
    
    /* 判断指定的路径是否存在，并判断路径是否为一个文件夹路径. */
    NSString *path = @"/Users/Apple/Desktop/dd1";
    
    BOOL flag = NO;
    BOOL res8 = [manager fileExistsAtPath:path isDirectory:&flag];
    // 先判断是否存在
    if (res8 == YES) {
        NSLog(@"给定的路径是存在的！");
        // 再判断路径是一个文件路经还是一个文件夹路径
        if (flag == YES) {
            // 说明给定的路径是一个文件夹路径
            NSLog(@"这是一个文件夹");
        } else {
    ...
    BOOL res9 = [manager fileExistsAtPath:path];
    LogBOOL(res9);
