...
int main(int argc, const char * argv[]) {
    ...
    [dict1 setObject:@"广州市xxx街" forKey:@"address"];
    [dict1 setObject:@"187.1" forKey:@"height"];
    
    [dict1 writeToFile:@"/Users/Apple/Desktop/dict.plist" atomically:NO];
    NSLog(@"YES");
    
    [dict1 setObject:@"xiaoDong" forKey:@"name"];
    [dict1 setObject:@"xiaoDongDong" forKey:@"name"];
    ...
    NSString *s1 = [dict6 objectForKey:@"age1"];
    
    NSLog(@"%@", dict6[@"name"]);
    NSLog(@"%@", dict6);
    
    NSDictionary *dict7 = [NSDictionary dictionaryWithObjectsAndKeys:@"jack", @"name", @"北京市xx街道", @"address", nil];
