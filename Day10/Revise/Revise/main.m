...
int main(int argc, const char * argv[]) {
    NSArray *arr = [NSArray arrayWithContentsOfFile:@"/Users/Applle/Desktop/abc.plist"];
    if (arr != nil) {
    ...
    NSArray *arr1 = @[@"jack", @"rose", @"lili", @"lucy"];
    [arr1 writeToFile:@"/Users/Apple/Desktop/abc.plist" atomically:NO];
    NSLog(@"YES");
