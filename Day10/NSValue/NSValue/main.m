...
int main(int argc, const char * argv[]) {
    ...
    NSValue *v5 = [NSValue valueWithPoint:p1];
    NSValue *v6 = [NSValue valueWithPoint:p2];
    NSValue *v7 = [NSValue valueWithPoint:p3];
    NSValue *v8 = [NSValue valueWithPoint:p4];
    
    NSArray *arr1 = @[v5, v6, v7, v8];
    
    for (NSValue *v in arr1) {
