...
int main(int argc, const char * argv[]) {
    ...
    Person *p2 = [[Person alloc] initWithName:@"小乔" andAge:19];
    
    BOOL res = [NSMutableString isSubclassOfClass:[NSString class]];
    NSLog(@"res = %d", res);
    NSMutableString *str = [NSMutableString new];
    // str对象是不是一个NSString对象或者他的子类对象。
    BOOL res1 = [str isMemberOfClass:[NSString class]];
    ...
    BOOL res3 = [p4 respondsToSelector:@selector(setName:)];
